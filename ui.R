...
shinyUI(navbarPage(
  ...
  tabPanel("Data Summary",
           sidebarLayout(
             sidebarPanel(
               radioButtons("RD1",label=h3(strong("Data Type")),choices = list("Pollutant Data"=2),selected = 2),
               ...
               numericInput("Start",strong("Start Period"),value = 2014),
               
               numericInput("freq",strong("Frequency"),value=12),
               h4(strong("Holdout Sample Setting")),
               numericInput("Starth",strong("Start Period"),value = 2017),
               numericInput("Endh",strong("End Period"),value = 2017)
             ),
                      ...
                      sidebarLayout(
                        ...
                        mainPanel(
                          fluidRow(
                            ...
                            column(10,h4(strong('Table')),tableOutput("out1"))
                          )
                        )
                      )),
                      ...
                      sidebarLayout(
                        ...
                        mainPanel(
                          fluidRow(
                            ...
                            column(10,h4(strong('Accuracy Table')),tableOutput("out2"))
                          )
                        )
                      )),
                      ...
                      sidebarLayout(
                        ...
                        mainPanel(
                          fluidRow(
                            ...
                            column(10,h4(strong('Table')),tableOutput("out3"))
                          )
                        )
                      ))),
           ...
           sidebarLayout(
             ...
             mainPanel(
               fluidRow(
                 ...
                 column(10,h4(strong('Accuracy Table')),tableOutput("out4"))
               )
             )
           )),
           ...
           sidebarLayout(
             ...
             mainPanel(
               fluidRow(
                 ...
                 column(10,h4(strong(' Table')),tableOutput("out6"))
               )
             )
           )),
  tabPanel("Read Me",
